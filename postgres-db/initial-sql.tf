# Database is VPC-restricted and requires connection from within VPC
# SQL scripts should be run manually from a bastion host or via your application
# Commenting out automatic execution for now
